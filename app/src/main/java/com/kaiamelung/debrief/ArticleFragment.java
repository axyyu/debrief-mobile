...
public class ArticleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<Article> artList = (ArrayList<Article>) getArguments().getSerializable(ARG_OBJECT2);
        Article a = artList.get(pos);
        TextView view = ((TextView) v.findViewById(R.id.article_name));
        view.setText(a.getHeadline());
        TextView view2 = ((TextView) v.findViewById(R.id.article_content));
        view2.setText(a.getLong());
